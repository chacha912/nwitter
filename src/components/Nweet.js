import { doc, deleteDoc, dbService, updateDoc, storageService, deleteObject, ref } from 'fbase';
    ...
    if (ok) {
      try {
        ...
        if (nweetObj.attachmentUrl !== '') {
          const attachmentRef = ref(storageService, `${nweetObj.creatorId}/${nweetObj.attachmentId}`);
